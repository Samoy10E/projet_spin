...
#define PanSource	"solitaire_europeen.pml"
...
#define _nstates1	137	/* :init: */
#define minseq1	31
#define maxseq1	166
#define _endstate1	136

#define _nstates0	32	/* pion */
#define minseq0	0
#define maxseq0	30
#define _endstate0	31
...
#define Ppion	((P0 *)_this)
typedef struct P0 { /* pion */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
